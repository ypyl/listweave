...
var $author$project$Main$ClickedAt = function (a) {
	return {$: 'ClickedAt', a: a};
};
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$clickedAt($author$project$Main$ClickedAt),
				function () {
...
var $author$project$Main$resizeTextarea = _Platform_outgoingPort('resizeTextarea', $elm$json$Json$Encode$int);
		...
		while (true) {
			switch (msg.$) {
				...
				case 'ClickedAt':
					var id = msg.a.id;
					var pos = msg.a.pos;
					var $temp$msg = $author$project$Main$EditItem(id),
						$temp$model = _Utils_update(
						model,
						{
							cursorPos: $elm$core$Maybe$Just(pos)
						});
					msg = $temp$msg;
					model = $temp$model;
					continue update;
				case 'EditItem':
					...
					var _v18 = function () {
						...
						if (_v19.$ === 'Just') {
							...
							var inputId = 'input-id-' + $elm$core$String$fromInt(id);
							return _Utils_Tuple2(
								newModel,
								A2(
			...
			var containsQuery = function (item) {
				...
				var itemTags = $elm$core$String$toLower(
					A2(
						...
						' ',
						$author$project$ListItem$getTags(item)));
				var tagMatches = $elm$core$List$isEmpty(searchWords) ? true : A2(
					$elm$core$List$any,
					function (word) {
						return A2($elm$core$String$contains, word, itemTags);
					},
					searchWords);
				var itemContent = $elm$core$String$toLower(
					A2(
						...
						' ',
						$author$project$ListItem$getContent(item)));
				var contentMatches = $elm$core$List$isEmpty(searchWords) ? true : A2(
					$elm$core$List$any,
					function (word) {
						return A2($elm$core$String$contains, word, itemContent);
					},
					searchWords);
