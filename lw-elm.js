...
var $author$project$ListItem$ListItem = function (a) {
	return {$: 'ListItem', a: a};
};
...
var $author$project$Main$initialModel = {
	...
	searchToolbar: $author$project$SearchToolbar$init,
	setCursorPositionTask: $elm$core$Maybe$Nothing,
	tagPopup: $author$project$TagPopup$init
};
var $author$project$Main$GetCurrentTime = function (a) {
	return {$: 'GetCurrentTime', a: a};
};
var $author$project$Main$GotCursorCoordinates = F5(
	function (a, b, c, d, e) {
		return {$: 'GotCursorCoordinates', a: a, b: b, c: c, d: d, e: e};
	});
...
var $author$project$Main$SetCursorPosition = F2(
	function (a, b) {
		return {$: 'SetCursorPosition', a: a, b: b};
	});
var $author$project$Main$SetSearchCursor = function (a) {
	return {$: 'SetSearchCursor', a: a};
};
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$SearchToolbar$getUpdatedCursorPosition = function (model) {
	return model.updatedCursorPosition;
};
...
var $author$project$Main$receiveCursorCoordinates = _Platform_incomingPort('receiveCursorCoordinates', $elm$json$Json$Decode$value);
var $author$project$Main$receiveCursorPosition = _Platform_incomingPort('receiveCursorPosition', $elm$json$Json$Decode$value);
var $author$project$Main$receiveFile = _Platform_incomingPort('receiveFile', $elm$json$Json$Decode$value);
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				function () {
				var _v0 = model.setCursorPositionTask;
				if (_v0.$ === 'Just') {
					var _v1 = _v0.a;
					var itemId = _v1.a;
					var line = _v1.b;
					...
					return $elm$browser$Browser$Events$onAnimationFrame(
						function (_v2) {
							return A2(
								$author$project$Main$SetCursorPosition,
								itemId,
				...
				$author$project$Main$receiveCursorCoordinates(
				function (value) {
					var _v5 = A2(
						$elm$json$Json$Decode$decodeValue,
						A6(
							$elm$json$Json$Decode$map5,
							$author$project$Main$GotCursorCoordinates,
					...
					if (_v5.$ === 'Ok') {
						...
						return A5($author$project$Main$GotCursorCoordinates, 0, 0, '', false, false);
					}
				}),
				...
				$author$project$Main$receiveFile($author$project$Main$ReceiveImportedModel)
			]));
};
var $author$project$Main$CreateItemAfter = F2(
	function (a, b) {
...
var $author$project$Main$IndentData = {$: 'IndentData'};
var $author$project$Main$InsertSelectedTag = F4(
	function (a, b, c, d) {
		return {$: 'InsertSelectedTag', a: a, b: b, c: c, d: d};
	});
var $author$project$Main$MoveDownData = {$: 'MoveDownData'};
var $author$project$Main$MoveUpData = {$: 'MoveUpData'};
var $author$project$Main$NavigateNextData = {$: 'NavigateNextData'};
var $author$project$Main$NavigatePreviousData = {$: 'NavigatePreviousData'};
var $author$project$Main$OutdentData = {$: 'OutdentData'};
...
var $author$project$Main$SplitLine = F3(
	function (a, b, c) {
		return {$: 'SplitLine', a: a, b: b, c: c};
	});
var $author$project$Main$SplitLineData = {$: 'SplitLineData'};
var $author$project$Main$TagInsertData = function (a) {
	return {$: 'TagInsertData', a: a};
};
...
var $author$project$Clipboard$clipboardPositionDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (list) {
		if (((list.b && list.b.b) && (list.b.a.$ === 'Just')) && (!list.b.b.b)) {
			var maybeIntValue = list.a;
			var _v1 = list.b;
			var intB = _v1.a.a;
			var maybeIntA = A2(
				$elm$core$Maybe$withDefault,
				$elm$core$Maybe$Nothing,
				A2($elm$core$Maybe$map, $elm$core$Maybe$Just, maybeIntValue));
			return $elm$json$Json$Decode$succeed(
				_Utils_Tuple2(maybeIntA, intB));
		} else {
			return $elm$json$Json$Decode$fail('ClipboardOriginalPosition list must have exactly 2 elements: [Maybe Int, Int]');
		}
	},
...
var $author$project$ListItem$posixDecoder = A2(
	$elm$json$Json$Decode$map,
	function (millis) {
		return $elm$time$Time$millisToPosix(
			$elm$core$Basics$round(millis));
	},
	$elm$json$Json$Decode$float);
function $author$project$ListItem$cyclic$decode() {
	return A2(
		$elm$json$Json$Decode$map,
		...
		A9(
			...
			F8(
				function (id, content, tags, children, collapsed, editing, created, updated) {
					return {children: children, collapsed: collapsed, content: content, created: created, editing: editing, id: id, tags: tags, updated: updated};
				}),
			...
			A2(
				...
				$elm$json$Json$Decode$list(
					$elm$json$Json$Decode$lazy(
						function (_v0) {
							return $author$project$ListItem$cyclic$decode();
						}))),
			A2($elm$json$Json$Decode$field, 'collapsed', $elm$json$Json$Decode$bool),
			A2($elm$json$Json$Decode$field, 'editing', $elm$json$Json$Decode$bool),
			A2($elm$json$Json$Decode$field, 'created', $author$project$ListItem$posixDecoder),
			A2($elm$json$Json$Decode$field, 'updated', $author$project$ListItem$posixDecoder)));
}
try {
	var $author$project$ListItem$decode = $author$project$ListItem$cyclic$decode();
	$author$project$ListItem$cyclic$decode = function () {
		return $author$project$ListItem$decode;
	};
} catch ($) {
	throw 'Some top-level definitions from `ListItem` are causing infinite recursion:\n\n  ┌─────┐\n  │    decode\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
var $author$project$Clipboard$decode = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Clipboard$Model,
	A2(
		$elm$json$Json$Decode$field,
		'clipboard',
		$elm$json$Json$Decode$nullable($author$project$ListItem$decode)),
	A2(
		$elm$json$Json$Decode$field,
		'clipboardOriginalPosition',
		$elm$json$Json$Decode$nullable($author$project$Clipboard$clipboardPositionDecoder)));
var $author$project$SearchToolbar$Model = F3(
	function (searchQuery, updatedCursorPosition, selectedTags) {
		return {searchQuery: searchQuery, selectedTags: selectedTags, updatedCursorPosition: updatedCursorPosition};
	});
var $author$project$SearchToolbar$decode = A4(
	$elm$json$Json$Decode$map3,
	$author$project$SearchToolbar$Model,
	A2($elm$json$Json$Decode$field, 'searchQuery', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
	...
	A2(
		...
		'selectedTags',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$TagPopup$Model = F4(
	function (position, tags, highlightedTag, source) {
		return {highlightedTag: highlightedTag, position: position, source: source, tags: tags};
	});
...
var $author$project$TagPopup$sourceDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (str) {
		switch (str) {
			case 'FromSearchToolbar':
				return $elm$json$Json$Decode$succeed($author$project$TagPopup$FromSearchToolbar);
			case 'FromItem':
				return $elm$json$Json$Decode$succeed($author$project$TagPopup$FromItem);
			default:
				return $elm$json$Json$Decode$fail('Unexpected source value: ' + str);
		}
	},
	$elm$json$Json$Decode$string);
var $author$project$TagPopup$decode = A5(
	$elm$json$Json$Decode$map4,
	$author$project$TagPopup$Model,
	A2(
		$elm$json$Json$Decode$field,
		'position',
		$elm$json$Json$Decode$nullable($author$project$TagPopup$positionDecoder)),
	A2(
		$elm$json$Json$Decode$field,
		'tags',
	...
	A2(
		$elm$json$Json$Decode$field,
		'source',
		$elm$json$Json$Decode$nullable($author$project$TagPopup$sourceDecoder)));
var $elm$json$Json$Decode$map7 = _Json_map7;
var $author$project$Main$decode = A8(
	$elm$json$Json$Decode$map7,
	F7(
		function (items, cursorPos, setCursorPositionTask, tagPopup, searchToolbar, noBlur, clipboard) {
			return {clipboard: clipboard, cursorPos: cursorPos, items: items, noBlur: noBlur, receiveCursorPositionTask: $elm$core$Maybe$Nothing, searchToolbar: searchToolbar, setCursorPositionTask: setCursorPositionTask, tagPopup: tagPopup};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'items',
		$elm$json$Json$Decode$list($author$project$ListItem$decode)),
	A2(
		$elm$json$Json$Decode$field,
		'cursorPos',
		$elm$json$Json$Decode$nullable($elm$json$Json$Decode$int)),
	A2(
		...
		$elm$json$Json$Decode$nullable(
			A4(
				...
				$elm$json$Json$Decode$int,
				$elm$json$Json$Decode$int))),
	A2($elm$json$Json$Decode$field, 'tagPopup', $author$project$TagPopup$decode),
...
var $author$project$ListItem$deleteItem = F2(
	function (_v0, list) {
		var item = _v0.a;
		var deleteItemRecursive = F2(
			function (innerId, innerList) {
				var loop = F2(
					function (processed, remaining) {
						loop:
						while (true) {
							if (!remaining.b) {
								return $elm$core$List$reverse(processed);
							} else {
								var current = remaining.a;
								var rest = remaining.b;
								var _v2 = current;
								var record = _v2.a;
								if (_Utils_eq(record.id, innerId)) {
									if (!processed.b) {
										var $temp$processed = processed,
											$temp$remaining = _Utils_ap(record.children, rest);
										processed = $temp$processed;
										remaining = $temp$remaining;
										continue loop;
									} else {
										var prev = processed.a;
										var processedTail = processed.b;
										var _v4 = prev;
										var prevRecord = _v4.a;
										var newPrev = $author$project$ListItem$ListItem(
											_Utils_update(
												prevRecord,
												{
													children: _Utils_ap(prevRecord.children, record.children)
												}));
										var $temp$processed = A2($elm$core$List$cons, newPrev, processedTail),
											$temp$remaining = rest;
										processed = $temp$processed;
										remaining = $temp$remaining;
										continue loop;
									...
									var newChildren = A2(deleteItemRecursive, innerId, record.children);
									var newItem = $author$project$ListItem$ListItem(
										_Utils_update(
											record,
											{children: newChildren}));
									var $temp$processed = A2($elm$core$List$cons, newItem, processed),
										$temp$remaining = rest;
									processed = $temp$processed;
									remaining = $temp$remaining;
									continue loop;
				...
				return A2(loop, _List_Nil, innerList);
			});
		return A2(deleteItemRecursive, item.id, list);
	});
var $author$project$Main$downloadJson = _Platform_outgoingPort(
	'downloadJson',
	function ($) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
...
var $author$project$ListItem$editItemFn = F2(
	function (id, _v0) {
		var item = _v0.a;
		return _Utils_eq(item.id, id) ? $author$project$ListItem$ListItem(
			_Utils_update(
				item,
				{editing: true})) : $author$project$ListItem$ListItem(
			_Utils_update(
				item,
				{editing: false}));
	});
...
var $author$project$ListItem$encode = function (_v0) {
	var item = _v0.a;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'children',
				A2($elm$json$Json$Encode$list, $author$project$ListItem$encode, item.children)),
				_Utils_Tuple2(
				'collapsed',
				$elm$json$Json$Encode$bool(item.collapsed)),
				_Utils_Tuple2(
				'editing',
				$elm$json$Json$Encode$bool(item.editing)),
				_Utils_Tuple2(
				'created',
				$elm$json$Json$Encode$float(
					$elm$time$Time$posixToMillis(item.created))),
				_Utils_Tuple2(
				'updated',
				$elm$json$Json$Encode$float(
					$elm$time$Time$posixToMillis(item.updated)))
			]));
};
var $elm$json$Json$Encode$null = _Json_encodeNull;
var $author$project$Clipboard$encode = function (model) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				A2(
					...
					A2($elm$core$Maybe$map, $author$project$ListItem$encode, model.clipboard))),
				_Utils_Tuple2(
				'clipboardOriginalPosition',
				A2(
					$elm$core$Maybe$withDefault,
							...
							return A2(
								...
								_List_fromArray(
									[
										...
										$elm$core$Maybe$withDefault,
										$elm$json$Json$Encode$null,
										A2($elm$core$Maybe$map, $elm$json$Json$Encode$int, a)),
										$elm$json$Json$Encode$int(b)
									]));
						},
						model.clipboardOriginalPosition)))
			]));
};
var $author$project$TagPopup$sourceEncoder = function (source) {
	if (source.$ === 'FromSearchToolbar') {
		return $elm$json$Json$Encode$string('FromSearchToolbar');
	} else {
		return $elm$json$Json$Encode$string('FromItem');
	}
};
var $author$project$TagPopup$encode = function (model) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $elm$json$Json$Encode$string, model.highlightedTag))),
				_Utils_Tuple2(
				'source',
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $author$project$TagPopup$sourceEncoder, model.source)))
			]));
};
var $author$project$SearchToolbar$encoder = function (model) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'searchQuery',
				$elm$json$Json$Encode$string(model.searchQuery)),
				_Utils_Tuple2(
				'updatedCursorPosition',
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $elm$json$Json$Encode$int, model.updatedCursorPosition))),
				_Utils_Tuple2(
				'selectedTags',
				A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, model.selectedTags))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'items',
				A2($elm$json$Json$Encode$list, $author$project$ListItem$encode, model.items)),
				_Utils_Tuple2(
				'cursorPos',
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $elm$json$Json$Encode$int, model.cursorPos))),
				_Utils_Tuple2(
				'setCursorPositionTask',
				A2(
					$elm$core$Maybe$withDefault,
				...
				_Utils_Tuple2('receiveCursorPositionTask', $elm$json$Json$Encode$null),
				_Utils_Tuple2(
				'tagPopup',
				$author$project$TagPopup$encode(model.tagPopup)),
				_Utils_Tuple2(
				'searchToolbar',
				$author$project$SearchToolbar$encoder(model.searchToolbar)),
				_Utils_Tuple2(
				'noBlur',
				$elm$json$Json$Encode$bool(model.noBlur)),
				_Utils_Tuple2(
				'clipboard',
				$author$project$Clipboard$encode(model.clipboard))
			]));
};
...
var $author$project$ListItem$isEditing = function (_v0) {
	var item = _v0.a;
	return item.editing;
};
var $author$project$ListItem$findEditingItem = function (items) {
	var findInList = function (itemList) {
		findInList:
		while (true) {
			if (!itemList.b) {
				return $elm$core$Maybe$Nothing;
				...
				var item = itemList.a;
				var rest = itemList.b;
				if ($author$project$ListItem$isEditing(item)) {
					return $elm$core$Maybe$Just(
						_Utils_Tuple2(item, 0));
				} else {
					var _v1 = findInList(
...
var $author$project$ListItem$elemIndex = F2(
	function (x, xs) {
		var helper = F2(
			function (idx, rest) {
				helper:
...
var $author$project$ListItem$flattenVisibleItems = function (items) {
	return A2(
		$elm$core$List$concatMap,
		function (item) {
			var _v0 = item;
			var record = _v0.a;
			return record.collapsed ? _List_fromArray(
				[item]) : A2(
				$elm$core$List$cons,
				item,
		...
		return A2(
			...
			function (index) {
				return $elm$core$List$head(
					A2($elm$core$List$drop, index + 1, visibleItems));
			},
...
var $author$project$ListItem$getAllTags = function (items) {
	var collectTags = function (listItem) {
		var item = listItem.a;
		return _Utils_ap(
			item.tags,
			A2(
				$elm$core$List$concatMap,
				collectTags,
				$author$project$ListItem$getChildren(listItem)));
	};
		...
		$elm$core$Set$fromList(
			A2(
				...
				A2(
					...
					A2($elm$core$List$concatMap, collectTags, items)))));
};
var $author$project$ListItem$getContent = function (_v0) {
	var record = _v0.a;
	return record.content;
};
var $author$project$TagPopup$getHighlightedTag = function (model) {
	return model.highlightedTag;
};
var $author$project$ListItem$getId = function (_v0) {
	var item = _v0.a;
	return item.id;
};
var $author$project$ListItem$getNextId = function (items) {
	var getMaxId = function (_v0) {
		var item = _v0.a;
		return A3(
			$elm$core$List$foldl,
			$elm$core$Basics$max,
			item.id,
			A2($elm$core$List$map, getMaxId, item.children));
	};
	var _v1 = A2($elm$core$List$map, getMaxId, items);
	if (!_v1.b) {
		return 1;
	} else {
		var maxIds = _v1;
...
var $author$project$ListItem$indentItem = F2(
	function (item, list) {
			...
			function (acc, remaining) {
				...
				while (true) {
					if (!remaining.b) {
						...
						var current = remaining.a;
						var rest = remaining.b;
						if (_Utils_eq(current, item)) {
							if (acc.b) {
								var prevRecord = acc.a.a;
								var accRest = acc.b;
								var newPrev = $author$project$ListItem$ListItem(
									_Utils_update(
										prevRecord,
								...
								return _Utils_ap(
									$elm$core$List$reverse(
										A2($elm$core$List$cons, newPrev, accRest)),
									rest);
							} else {
								return _Utils_ap(
							...
							var $temp$acc = A2($elm$core$List$cons, current, acc),
								$temp$remaining = rest;
							acc = $temp$acc;
							remaining = $temp$remaining;
							continue loop;
		...
		var result = A2(loop, _List_Nil, list);
		return _Utils_eq(result, list) ? A2(
			$elm$core$List$map,
			function (_v2) {
				var record = _v2.a;
				return $author$project$ListItem$ListItem(
					_Utils_update(
						record,
						{
							children: A2($author$project$ListItem$indentItem, item, record.children)
						}));
			},
			list) : result;
	});
...
var $author$project$ListItem$insertItemAfter = F4(
	function (after, newId, list, currentTime) {
		...
		if (!list.b) {
			...
			var _v1 = item;
			var record = _v1.a;
			return _Utils_eq(record.id, afterItem.id) ? A2(
				$elm$core$List$cons,
				item,
				A2(
					$elm$core$List$cons,
				...
				$author$project$ListItem$ListItem(
					_Utils_update(
						record,
						{
							children: A4($author$project$ListItem$insertItemAfter, after, newId, record.children, currentTime)
						})),
			...
			A2(
				...
				$elm$core$List$head(
					A2(
						...
						$elm$core$String$reverse(beforeColumn)))));
		var newColumn = (tagStart + $elm$core$String$length($author$project$TagsUtils$tagPrefix)) + $elm$core$String$length(tag);
		var afterColumn = A2($elm$core$String$dropLeft, column, targetLine);
		var newLine = _Utils_ap(
			A2($elm$core$String$left, tagStart, targetLine),
			_Utils_ap(
				$author$project$TagsUtils$tagPrefix,
...
var $author$project$TagsUtils$tagPostfix = '';
var $author$project$TagsUtils$isTagRegex = A2(
	$elm$core$Maybe$withDefault,
	$elm$regex$Regex$never,
	$elm$regex$Regex$fromString($author$project$TagsUtils$tagPrefix + ('([a-zA-Z0-9-_]*)' + $author$project$TagsUtils$tagPostfix)));
var $author$project$TagsUtils$focusedTag = F2(
	function (idx, content) {
		return A2(
			$elm$core$Maybe$map,
			function (match) {
				var _v0 = $elm$core$List$head(match.submatches);
				if ((_v0.$ === 'Just') && (_v0.a.$ === 'Just')) {
					var submatch = _v0.a.a;
					return {
						position: idx - (match.index + $elm$core$String$length($author$project$TagsUtils$tagPrefix)),
						tag: submatch
					};
				} else {
					return {
			...
			$elm$core$List$head(
				A2(
					...
					function (m) {
						var start = m.index;
						var end = m.index + $elm$core$String$length(m.match);
						return (_Utils_cmp(idx, start) > -1) && (_Utils_cmp(idx, end) < 1);
					},
	...
	function (cursorPos, content) {
		return A2($author$project$TagsUtils$isInsideCodeBlock, cursorPos, content) ? $elm$core$Maybe$Nothing : A2(
			...
			function (_v0) {
				...
				return _Utils_Tuple2(
					A2($elm$core$String$left, position, tag),
					tag);
			},
			...
			function (item) {
				...
				return $author$project$ListItem$ListItem(
					_Utils_update(
						record,
						{
							children: A2($author$project$ListItem$mapItem, fn, record.children)
						}));
			},
			list);
	});
...
var $author$project$ListItem$moveItem = F2(
	function (predicate, items) {
					...
					if (!remaining.b) {
						...
						if (!remaining.b.b) {
							...
							if (A2(predicate, x, y)) {
								...
								var $temp$processed = _Utils_ap(
									processed,
									_List_fromArray(
										[x])),
									$temp$remaining = A2($elm$core$List$cons, y, ys);
								processed = $temp$processed;
								remaining = $temp$remaining;
								continue move;
							}
		...
		return A2(move, _List_Nil, items);
	});
var $author$project$ListItem$moveItemDown = F2(
	function (target, items) {
		return A2(
			$author$project$ListItem$moveItem,
			F2(
				function (x, _v0) {
...
var $author$project$ListItem$moveItemInTree = F3(
	function (moveFn, target, items) {
		var applyMove = function (list) {
			return A2(
				$elm$core$List$any,
				function (item) {
					return _Utils_eq(item, target);
				},
				list) ? A2(moveFn, target, list) : A2(
				$elm$core$List$map,
				function (item) {
					var data = item.a;
					return $author$project$ListItem$ListItem(
						_Utils_update(
							data,
							{
								children: applyMove(data.children)
							}));
				},
				list);
		};
		return applyMove(items);
	});
var $author$project$ListItem$moveItemUp = F2(
	function (target, items) {
		return A2(
			$author$project$ListItem$moveItem,
			F2(
				function (_v0, y) {
					return _Utils_eq(y, target);
				}),
			items);
	});
...
var $author$project$ListItem$outdentItem = F2(
	function (item, list) {
		var removeAndLift = F2(
			function (acc, remaining) {
				removeAndLift:
				while (true) {
					if (!remaining.b) {
						...
						var _v2 = A2(
							...
							function (r) {
								return _Utils_eq(r, item);
							},
							record.children);
						if (!_v2.a.b) {
							var _v3 = A2(removeAndLift, _List_Nil, record.children);
							var newChildren = _v3.a;
							var innerFound = _v3.b;
							var newCurrent = $author$project$ListItem$ListItem(
								_Utils_update(
									record,
									{children: newChildren}));
							var _v4 = innerFound ? _Utils_Tuple2(
								_Utils_ap(
									$elm$core$List$reverse(
										A2($elm$core$List$cons, newCurrent, acc)),
									rest),
								true) : A2(
								removeAndLift,
								A2($elm$core$List$cons, newCurrent, acc),
							...
							var processed = _v4.a;
							var done = _v4.b;
							return done ? _Utils_Tuple2(processed, true) : _Utils_Tuple2(processed, false);
						} else {
							var matched = _v2.a;
							var remainingChildren = _v2.b;
							if (!matched.b) {
								var $temp$acc = A2($elm$core$List$cons, current, acc),
									$temp$remaining = rest;
								acc = $temp$acc;
								remaining = $temp$remaining;
								continue removeAndLift;
							} else {
								var m = matched.a;
								var newCurrent = $author$project$ListItem$ListItem(
									_Utils_update(
								...
								var newAcc = _Utils_ap(
									$elm$core$List$reverse(
										A2($elm$core$List$cons, newCurrent, acc)),
									A2($elm$core$List$cons, m, rest));
								return _Utils_Tuple2(newAcc, true);
							}
						}
					}
				}
			});
		var _v6 = A2(removeAndLift, _List_Nil, list);
		var result = _v6.a;
		var found = _v6.b;
		return found ? result : A2(
			$elm$core$List$map,
			function (_v7) {
				var record = _v7.a;
				return $author$project$ListItem$ListItem(
					_Utils_update(
						record,
						{
							children: A2($author$project$ListItem$outdentItem, item, record.children)
						}));
			},
			list);
	});
...
var $author$project$ListItem$parseInnerHtml = function (html) {
	...
	var withCodeMarkers = function () {
		var prefix = '<pre><code';
		var replacePreCode = function (s) {
			replacePreCode:
			while (true) {
				var _v4 = A2($elm$core$String$indexes, prefix, s);
				if (!_v4.b) {
					return s;
				} else {
					var idx = _v4.a;
					var rest = A3(
						$elm$core$String$slice,
						idx + $elm$core$String$length(prefix),
						$elm$core$String$length(s),
						s);
					var before = A3($elm$core$String$slice, 0, idx, s);
					var _v5 = A2($elm$core$String$indexes, '>', rest);
					if (!_v5.b) {
						return s;
					} else {
						var closeIdx = _v5.a;
						var after = A3(
							...
							$elm$core$String$length(rest),
							rest);
						var $temp$s = before + ('||CODE_START||' + after);
						s = $temp$s;
						continue replacePreCode;
					}
				}
			}
		};
...
var $author$project$Main$requestCursorCoordinates = _Platform_outgoingPort(
	'requestCursorCoordinates',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
...
var $author$project$SearchToolbar$resetUpdatedCursorPosition = function (model) {
	return _Utils_update(
		model,
		{updatedCursorPosition: $elm$core$Maybe$Nothing});
};
var $author$project$ListItem$saveItemFn = F2(
	function (_v0, _v1) {
		var current = _v0.a;
		var item = _v1.a;
...
var $author$project$SearchToolbar$selectTag = F2(
	function (tag, model) {
		return ($elm$core$String$isEmpty(tag) || A2($elm$core$List$member, tag, model.selectedTags)) ? model : _Utils_update(
			model,
			{
...
var $author$project$ListItem$setAllCollapsed = F2(
	function (collapsedFlag, items) {
		return A2(
			$elm$core$List$map,
			function (_v0) {
				var item = _v0.a;
				return $author$project$ListItem$ListItem(
					_Utils_update(
						item,
						{
							children: A2($author$project$ListItem$setAllCollapsed, collapsedFlag, item.children),
							collapsed: collapsedFlag
						}));
			},
			items);
	});
var $author$project$Main$setCursorPosition = _Platform_outgoingPort(
	'setCursorPosition',
	function ($) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'line',
					$elm$json$Json$Encode$int($.line))
				]));
	});
var $author$project$Main$setSearchInputCursor = _Platform_outgoingPort('setSearchInputCursor', $elm$json$Json$Encode$int);
var $author$project$TagPopup$setTags = F2(
	function (_v0, model) {
		var tags = _v0.a;
		var source = _v0.b;
		return _Utils_update(
...
var $author$project$ListItem$getCreated = function (_v0) {
	var record = _v0.a;
	return record.created;
};
var $author$project$ListItem$getUpdated = function (_v0) {
	var record = _v0.a;
	return record.updated;
};
var $elm$core$List$sortBy = _List_sortBy;
var $author$project$ListItem$sortItemsByDate = F2(
	function (sortOrder, items) {
		var fn = function () {
			if (sortOrder.$ === 'ByCreatedDate') {
				return $author$project$ListItem$getCreated;
			} else {
				return $author$project$ListItem$getUpdated;
			}
		}();
		...
		var sortedItems = $elm$core$List$reverse(
			A2($elm$core$List$sortBy, sortByDate, items));
		return A2(
			$elm$core$List$map,
			function (item) {
				var _v0 = item;
				...
				return $author$project$ListItem$ListItem(
					_Utils_update(
						record,
						{
							children: A2($author$project$ListItem$sortItemsByDate, sortOrder, record.children)
						}));
			},
			sortedItems);
	});
var $author$project$ListItem$toggleCollapseFn = F2(
	function (_v0, _v1) {
		var current = _v0.a;
		var item = _v1.a;
		return _Utils_eq(item.id, current.id) ? $author$project$ListItem$ListItem(
			_Utils_update(
				item,
				{collapsed: !item.collapsed})) : $author$project$ListItem$ListItem(item);
	});
...
var $author$project$ListItem$findItemPosition = F2(
	function (target, items) {
		var findInList = F2(
			function (parentId, list) {
				var _v0 = A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, list);
				if (!_v0.b) {
					return $elm$core$Maybe$Nothing;
				} else {
					var indexedItems = _v0;
					return A3(
						$elm$core$List$foldl,
						F2(
							function (_v1, acc) {
								...
								if (acc.$ === 'Just') {
									...
									if (_Utils_eq(item, target)) {
										return $elm$core$Maybe$Just(
											_Utils_Tuple2(parentId, index));
									} else {
										var data = item.a;
										return A2(
											findInList,
		...
		return A2(findInList, $elm$core$Maybe$Nothing, items);
	});
var $author$project$ListItem$insertClipboardItemAfter = F3(
	function (targetItem, clipboardItem, items) {
		var insertInList = function (list) {
			if (!list.b) {
				return _List_Nil;
			} else {
				var item = list.a;
				var rest = list.b;
				if (_Utils_eq(item, targetItem)) {
					return A2(
						$elm$core$List$cons,
						item,
						A2($elm$core$List$cons, clipboardItem, rest));
				} else {
					var data = item.a;
					return A2(
						$elm$core$List$cons,
						$author$project$ListItem$ListItem(
							_Utils_update(
								data,
								{
									children: insertInList(data.children)
								})),
						insertInList(rest));
				}
			}
...
var $author$project$ListItem$splitAt = F2(
	function (n, list) {
		return _Utils_Tuple2(
			A2($elm$core$List$take, n, list),
			A2($elm$core$List$drop, n, list));
	});
var $author$project$ListItem$restoreItemAtPosition = F4(
	function (item, parentId, childIndex, items) {
		if (parentId.$ === 'Nothing') {
			var _v1 = A2($author$project$ListItem$splitAt, childIndex, items);
			var before = _v1.a;
			var after = _v1.b;
			return _Utils_ap(
				before,
			...
			return A2(
				...
				function (currentItem) {
					var data = currentItem.a;
					if (_Utils_eq(data.id, pid)) {
						var _v3 = A2($author$project$ListItem$splitAt, childIndex, data.children);
						var before = _v3.a;
						var after = _v3.b;
						return $author$project$ListItem$ListItem(
							_Utils_update(
						...
						return $author$project$ListItem$ListItem(
							_Utils_update(
								data,
								{
									children: A4($author$project$ListItem$restoreItemAtPosition, item, parentId, childIndex, data.children)
								}));
					}
				},
				items);
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'CutItem':
				...
				var items = msg.b;
				var _v1 = function () {
					var _v2 = model.clipboard;
					if (_v2.$ === 'Just') {
						var _v3 = A2(
							$author$project$Clipboard$update,
							$author$project$Clipboard$RestoreCutItem(items),
							model);
						var restoredModel = _v3.a;
						var restoredItems = _v3.b;
						return _Utils_Tuple2(restoredModel, restoredItems);
					} else {
						return _Utils_Tuple2(model, items);
					}
				}();
				var modelAfterRestore = _v1.a;
				var itemsAfterRestore = _v1.b;
				var newItems = A2($author$project$ListItem$removeItemCompletely, item, itemsAfterRestore);
				var originalPosition = A2($author$project$ListItem$findItemPosition, item, itemsAfterRestore);
				return _Utils_Tuple3(
					_Utils_update(
						modelAfterRestore,
						{
							clipboard: $elm$core$Maybe$Just(item),
							clipboardOriginalPosition: originalPosition
						}),
					newItems,
					$elm$core$Maybe$Nothing);
			case 'PasteItem':
				var targetItem = msg.a;
				var items = msg.b;
				var _v4 = model.clipboard;
				if (_v4.$ === 'Just') {
					var clipboardItem = _v4.a;
					var newItems = A3($author$project$ListItem$insertClipboardItemAfter, targetItem, clipboardItem, items);
					return _Utils_Tuple3(
						_Utils_update(
							model,
							{clipboard: $elm$core$Maybe$Nothing, clipboardOriginalPosition: $elm$core$Maybe$Nothing}),
						newItems,
						$elm$core$Maybe$Just(
							_Utils_Tuple3(
								$author$project$ListItem$getId(targetItem),
								0,
								0)));
				} else {
					return _Utils_Tuple3(model, items, $elm$core$Maybe$Nothing);
				}
			default:
				var items = msg.a;
				var _v5 = _Utils_Tuple2(model.clipboard, model.clipboardOriginalPosition);
				if ((_v5.a.$ === 'Just') && (_v5.b.$ === 'Just')) {
					var clipboardItem = _v5.a.a;
					var _v6 = _v5.b.a;
					var parentId = _v6.a;
					var childIndex = _v6.b;
					var newItems = A4($author$project$ListItem$restoreItemAtPosition, clipboardItem, parentId, childIndex, items);
					return _Utils_Tuple3(
						_Utils_update(
							model,
							{clipboard: $elm$core$Maybe$Nothing, clipboardOriginalPosition: $elm$core$Maybe$Nothing}),
...
var $author$project$Actions$ImportModel = {$: 'ImportModel'};
...
var $author$project$Actions$SetSortOrder = function (a) {
	return {$: 'SetSortOrder', a: a};
};
var $author$project$Actions$ByCreatedDate = {$: 'ByCreatedDate'};
var $author$project$Actions$ByUpdatedDate = {$: 'ByUpdatedDate'};
var $author$project$SearchToolbar$getSortOrder = function (sortOrder) {
	switch (sortOrder) {
		case 'Updated Date':
			return $author$project$Actions$ByUpdatedDate;
		case 'Created Date':
			return $author$project$Actions$ByCreatedDate;
		default:
			return $author$project$Actions$ByCreatedDate;
	}
};
...
var $author$project$SearchToolbar$tagRegex = A2(
	$elm$core$Maybe$withDefault,
	$elm$regex$Regex$never,
	$elm$regex$Regex$fromString('@[a-zA-Z0-9-_]*'));
var $author$project$SearchToolbar$whitespaceRegex = A2(
	$elm$core$Maybe$withDefault,
	$elm$regex$Regex$never,
	$elm$regex$Regex$fromString('\\s+'));
var $author$project$SearchToolbar$removeTagFromQueryWithPosition = function (query) {
	var matches = A2($elm$regex$Regex$find, $author$project$SearchToolbar$tagRegex, query);
	var lastMatch = $elm$core$List$head(
		$elm$core$List$reverse(matches));
	var _v0 = function () {
		if (lastMatch.$ === 'Just') {
			var match = lastMatch.a;
			var beforeMatch = A2($elm$core$String$left, match.index, query);
			var afterMatch = A2(
				$elm$core$String$dropLeft,
				match.index + $elm$core$String$length(match.match),
				query);
			var cleaned = _Utils_ap(beforeMatch, afterMatch);
			return _Utils_Tuple2(cleaned, match.index);
		} else {
			return _Utils_Tuple2(
				query,
	...
	var cleanQuery = _v0.a;
	var cursorPos = _v0.b;
	return _Utils_Tuple2(
		A3(
			$elm$regex$Regex$replace,
			$author$project$SearchToolbar$whitespaceRegex,
			function (_v2) {
				return ' ';
			},
			$elm$core$String$trim(cleanQuery)),
		cursorPos);
};
var $author$project$SearchToolbar$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SortOrderChanged':
				...
				return _Utils_Tuple2(
					model,
					$elm$core$Maybe$Just(
						$author$project$Actions$SetSortOrder(
							$author$project$SearchToolbar$getSortOrder(sortOrder))));
			case 'SearchKeyDown':
				var key = msg.a;
				switch (key) {
					case 13:
						var _v2 = $author$project$SearchToolbar$removeTagFromQueryWithPosition(model.searchQuery);
						var cleanQuery = _v2.a;
						var cursorPos = _v2.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
			...
			case 'ClearAllSelectedTags':
				return _Utils_Tuple2(
					...
					$elm$core$Maybe$Nothing);
			case 'AddTagToSelected':
				var tag = msg.a;
				return ($elm$core$String$isEmpty(tag) || A2($elm$core$List$member, tag, model.selectedTags)) ? _Utils_Tuple2(model, $elm$core$Maybe$Nothing) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							selectedTags: _Utils_ap(
			...
			case 'ExportModel':
				return _Utils_Tuple2(
					model,
					$elm$core$Maybe$Just($author$project$Actions$ExportModel));
			default:
				return _Utils_Tuple2(
					model,
					$elm$core$Maybe$Just($author$project$Actions$ImportModel));
		}
	});
	...
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				case 'NoOp':
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				case 'AddNewLineAfter':
					var item = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								receiveCursorPositionTask: $elm$core$Maybe$Just($author$project$Main$SplitLineData)
							}),
						$author$project$Main$requestCursorPosition(
							{
								itemId: $author$project$ListItem$getId(item)
							}));
				case 'InsertSelectedTagAfter':
					var item = msg.a;
					var tag = msg.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								receiveCursorPositionTask: $elm$core$Maybe$Just(
									$author$project$Main$TagInsertData(tag))
							}),
						$author$project$Main$requestCursorPosition(
							{
								itemId: $author$project$ListItem$getId(item)
				...
				case 'MoveItemUpAfter':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								receiveCursorPositionTask: $elm$core$Maybe$Just($author$project$Main$MoveUpData)
							}),
						$author$project$Main$requestCursorPosition(
							{
								itemId: $author$project$ListItem$getId(item)
							}));
				case 'MoveItemDownAfter':
					var item = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								receiveCursorPositionTask: $elm$core$Maybe$Just($author$project$Main$MoveDownData)
							}),
						$author$project$Main$requestCursorPosition(
							{
								itemId: $author$project$ListItem$getId(item)
							}));
				case 'IndentItemAfter':
					var item = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								receiveCursorPositionTask: $elm$core$Maybe$Just($author$project$Main$IndentData)
							}),
						$author$project$Main$requestCursorPosition(
							{
								itemId: $author$project$ListItem$getId(item)
							}));
				case 'OutdentItemAfter':
					var item = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								receiveCursorPositionTask: $elm$core$Maybe$Just($author$project$Main$OutdentData)
							}),
						$author$project$Main$requestCursorPosition(
							{
								itemId: $author$project$ListItem$getId(item)
							}));
				case 'NavigateToPreviousAfter':
					var item = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								receiveCursorPositionTask: $elm$core$Maybe$Just($author$project$Main$NavigatePreviousData)
							}),
						$author$project$Main$requestCursorPosition(
							{
								itemId: $author$project$ListItem$getId(item)
							}));
				case 'NavigateToNextAfter':
					var item = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								receiveCursorPositionTask: $elm$core$Maybe$Just($author$project$Main$NavigateNextData)
							}),
						$author$project$Main$requestCursorPosition(
							{
								itemId: $author$project$ListItem$getId(item)
				...
				case 'GetCurrentCursorCoordinates':
					return _Utils_Tuple2(
						model,
						$author$project$Main$requestCursorCoordinates(_Utils_Tuple0));
				case 'ReceiveImportedModel':
					var jsonValue = msg.a;
					var _v3 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decode, jsonValue);
					if (_v3.$ === 'Ok') {
						var newModel = _v3.a;
				...
				case 'TagPopupMsg':
					...
					var _v4 = A2($author$project$TagPopup$update, tagPopupMsg, model.tagPopup);
					var updatedmodel = _v4.a;
					var action = _v4.b;
					if (action.$ === 'Just') {
						var tag = action.a.a;
						var _v6 = $author$project$TagPopup$currentSource(model.tagPopup);
						if (_v6.$ === 'Just') {
							if (_v6.a.$ === 'FromSearchToolbar') {
								var _v7 = _v6.a;
								var _v8 = A2(
									$author$project$SearchToolbar$update,
									$author$project$SearchToolbar$SearchKeyDown(13),
									model.searchToolbar);
								var searchToolbarUpdatedModel = _v8.a;
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
								...
								if (_v10.$ === 'Just') {
									...
									return _Utils_Tuple2(
										...
										$author$project$Main$requestCursorPosition(
											{
												itemId: $author$project$ListItem$getId(editingItem)
											}));
								} else {
									return _Utils_Tuple2(
										_Utils_update(
				...
				case 'SearchToolbarMsg':
					...
					var _v12 = A2($author$project$SearchToolbar$update, searchToolbarMsg, model.searchToolbar);
					var updatedSearchToolbarModel = _v12.a;
					var action = _v12.b;
							...
							switch (act.$) {
								...
								case 'SetSortOrder':
									...
									return _Utils_Tuple2(
										...
										$elm$core$Platform$Cmd$none);
								case 'KeyEnter':
									var _v16 = $author$project$TagPopup$getHighlightedTag(model.tagPopup);
									if (_v16.$ === 'Just') {
										var tag = _v16.a;
										return _Utils_Tuple2(
											_Utils_update(
								...
								default:
									...
									var updatedTagPopup = _v17.a;
									var updatedCmd = _v17.b;
									return _Utils_Tuple2(
										_Utils_update(
											withSearchToolbar,
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								items: A2(
									$author$project$ListItem$mapItem,
									$author$project$ListItem$toggleCollapseFn(item),
									model.items)
							}),
						$elm$core$Platform$Cmd$none);
				case 'SetCursorPosition':
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{setCursorPositionTask: $elm$core$Maybe$Nothing}),
						$author$project$Main$setCursorPosition(
							{column: column, id: itemId, line: line}));
				case 'SetSearchCursor':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								searchToolbar: $author$project$SearchToolbar$resetUpdatedCursorPosition(model.searchToolbar)
							}),
						$author$project$Main$setSearchInputCursor(pos));
				case 'ReceiveCursorPosition':
					...
					var _v21 = A2($author$project$ListItem$findInForest, itemId, model.items);
					if (_v21.$ === 'Just') {
						var item = _v21.a;
						...
						var updatedItem = A2(
							$elm$core$Maybe$withDefault,
							item,
							A2($author$project$ListItem$findInForest, itemId, updatedModel.items));
						var _v22 = updatedModel.receiveCursorPositionTask;
						if (_v22.$ === 'Just') {
							switch (_v22.a.$) {
								case 'SplitLineData':
									var _v23 = _v22.a;
									var $temp$msg = A3(
										$author$project$Main$SplitLine,
										updatedItem,
										_Utils_Tuple2(line, column),
										currentTime),
								...
								case 'TagInsertData':
									var tag = _v22.a.a;
									var $temp$msg = A4(
										$author$project$Main$InsertSelectedTag,
										updatedItem,
										tag,
										_Utils_Tuple2(line, column),
										currentTime),
								...
								case 'MoveUpData':
									...
									return _Utils_Tuple2(
										_Utils_update(
											updatedModel,
											{
												items: A3($author$project$ListItem$moveItemInTree, $author$project$ListItem$moveItemUp, updatedItem, updatedModel.items),
												noBlur: true,
												receiveCursorPositionTask: $elm$core$Maybe$Nothing,
												setCursorPositionTask: $elm$core$Maybe$Just(
													_Utils_Tuple3(
								...
								case 'MoveDownData':
									...
									return _Utils_Tuple2(
										_Utils_update(
											updatedModel,
											{
												items: A3($author$project$ListItem$moveItemInTree, $author$project$ListItem$moveItemDown, updatedItem, updatedModel.items),
												noBlur: true,
												receiveCursorPositionTask: $elm$core$Maybe$Nothing,
												setCursorPositionTask: $elm$core$Maybe$Just(
													_Utils_Tuple3(
								...
								case 'IndentData':
									...
									return _Utils_Tuple2(
										_Utils_update(
											updatedModel,
											{
												items: A2($author$project$ListItem$indentItem, updatedItem, updatedModel.items),
												noBlur: true,
												receiveCursorPositionTask: $elm$core$Maybe$Nothing,
												setCursorPositionTask: $elm$core$Maybe$Just(
													_Utils_Tuple3(
								...
								case 'OutdentData':
									...
									return _Utils_Tuple2(
										_Utils_update(
											updatedModel,
											{
												items: A2($author$project$ListItem$outdentItem, updatedItem, updatedModel.items),
												noBlur: true,
												receiveCursorPositionTask: $elm$core$Maybe$Nothing,
												setCursorPositionTask: $elm$core$Maybe$Just(
													_Utils_Tuple3(
								...
								case 'NavigatePreviousData':
									...
									if (line > 0) {
										...
										var _v29 = A2($author$project$ListItem$findPreviousItem, updatedItem, updatedModel.items);
										if (_v29.$ === 'Just') {
											var prevItem = _v29.a;
								...
								default:
									...
									if (_Utils_cmp(line, lastLineIndex) < 0) {
										...
										var _v31 = A2($author$project$ListItem$findNextItem, item, updatedModel.items);
										if (_v31.$ === 'Just') {
											var nextItem = _v31.a;
				...
				case 'MoveItemDown':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								items: A3($author$project$ListItem$moveItemInTree, $author$project$ListItem$moveItemDown, item, model.items),
								noBlur: true
							}),
						$elm$core$Platform$Cmd$none);
				case 'IndentItem':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								items: A2($author$project$ListItem$indentItem, item, model.items),
								noBlur: true
							}),
						$elm$core$Platform$Cmd$none);
				case 'OutdentItem':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								items: A2($author$project$ListItem$outdentItem, item, model.items),
								noBlur: true
							}),
						$elm$core$Platform$Cmd$none);
				case 'GotCursorCoordinates':
					var top = msg.a;
					var left = msg.b;
					var fragment = msg.c;
					var ok = msg.d;
				...
				case 'CreateItemAfter':
					...
					var newItems = A2(
						$author$project$ListItem$mapItem,
						$author$project$ListItem$editItemFn(newId),
						A4($author$project$ListItem$insertItemAfter, item, newId, model.items, currentTime));
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{items: newItems}),
				...
				case 'InsertSelectedTag':
					...
					var _v35 = A3(
						...
						A2(
							...
							'',
							$author$project$ListItem$getContent(item)),
						A2($elm$core$Debug$log, 'tag', tag),
						_Utils_Tuple2(
							line,
							A2($elm$core$Debug$log, 'column', column)));
					var newContent = _v35.a;
					var _v36 = _v35.b;
					var newLine = _v36.a;
					var newColumn = _v36.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								items: A2(
									...
									A3(
										...
										item,
										A2($elm$core$Debug$log, 'newContent', newContent),
										currentTime),
									model.items),
								noBlur: false,
								setCursorPositionTask: $elm$core$Maybe$Just(
				...
				case 'NavigateToPreviousWithColumn':
					var item = msg.a;
					var columnPos = msg.b;
					var _v37 = A2($author$project$ListItem$findPreviousItem, item, model.items);
					if (_v37.$ === 'Just') {
						var prevItem = _v37.a;
						var prevLines = $author$project$ContentBlock$contentBlocksToLines(
							$author$project$ListItem$getContent(prevItem));
				...
				default:
					...
					var _v39 = A2($author$project$Clipboard$update, clipboardMsg, model.clipboard);
					var updatedClipboard = _v39.a;
					var updatedItems = _v39.b;
					var maybeCaretTask = _v39.c;
					var newCaretTask = function () {
						if (maybeCaretTask.$ === 'Just') {
							var caretTask = maybeCaretTask.a;
							return $elm$core$Maybe$Just(caretTask);
						} else {
							return model.setCursorPositionTask;
						}
					}();
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{clipboard: updatedClipboard, items: updatedItems, setCursorPositionTask: newCaretTask}),
						$elm$core$Platform$Cmd$none);
			}
		}
	});
					...
					return $elm$core$Maybe$Just(
						$author$project$ListItem$ListItem(
							_Utils_update(
								data,
								{
									children: A2($elm$core$List$filterMap, filterItemAndChildren, data.children)
								})));
				} else {
					var _v1 = A2($elm$core$List$filterMap, filterItemAndChildren, data.children);
					if (!_v1.b) {
						return $elm$core$Maybe$Nothing;
					} else {
						var filteredChildren = _v1;
						return $elm$core$Maybe$Just(
							$author$project$ListItem$ListItem(
								_Utils_update(
									data,
...
var $author$project$SearchToolbar$getFilteredItems = function (model) {
	return A2($author$project$ListItem$filterItems, model.searchQuery, model.selectedTags);
};
var $author$project$TagPopup$isVisible = function (model) {
	var _v0 = _Utils_Tuple2(model.position, model.tags);
	if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
		var tags = _v0.b.a;
		return !$elm$core$List$isEmpty(tags);
	} else {
		return false;
	}
};
...
var $author$project$Theme$buttonGroupFirst = _Utils_ap(
	$author$project$Theme$buttonGroupBase,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'border-radius', $author$project$Theme$layout.borderRadius + (' 0 0 ' + $author$project$Theme$layout.borderRadius))
		]));
var $author$project$Theme$buttonGroupLast = _Utils_ap(
	$author$project$Theme$buttonGroupBase,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'border-right', '1px solid ' + $author$project$Theme$colors.border),
			A2($elm$html$Html$Attributes$style, 'border-radius', '0 ' + ($author$project$Theme$layout.borderRadius + (' ' + ($author$project$Theme$layout.borderRadius + ' 0'))))
		]));
var $author$project$SearchToolbar$SearchQueryChanged = F2(
	function (a, b) {
		return {$: 'SearchQueryChanged', a: a, b: b};
	});
var $author$project$SearchToolbar$inputDecoder = A3(
	$elm$json$Json$Decode$map2,
	F2(
		function (value, selectionStart) {
			return _Utils_Tuple2(
				A2($author$project$SearchToolbar$SearchQueryChanged, value, selectionStart),
				false);
		}),
	A2(
		$elm$json$Json$Decode$field,
...
var $author$project$SearchToolbar$keydownDecoder = function (listenKeydownEvents) {
	return A2(
		$elm$json$Json$Decode$map,
		function (key) {
			var shouldPrevent = listenKeydownEvents && ((key === 13) || ((key === 38) || (key === 40)));
			return _Utils_Tuple2(
				$author$project$SearchToolbar$SearchKeyDown(key),
				shouldPrevent);
		},
...
var $author$project$Theme$searchToolbar = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'margin-bottom', $author$project$Theme$spacing.xs),
		A2($elm$html$Html$Attributes$style, 'display', 'flex'),
		A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
		A2($elm$html$Html$Attributes$style, 'gap', $author$project$Theme$spacing.sm)
	]);
var $author$project$Theme$select = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'display', 'flex'),
...
var $author$project$SearchToolbar$ClearAllSelectedTags = {$: 'ClearAllSelectedTags'};
var $author$project$SearchToolbar$viewClearAllButton = A2(
	$elm$html$Html$div,
	A2(
		$elm$core$List$cons,
		$elm$html$Html$Events$onClick($author$project$SearchToolbar$ClearAllSelectedTags),
		$author$project$Theme$button),
	_List_fromArray(
		[
			$elm$html$Html$text('Clear all')
		]));
var $author$project$SearchToolbar$RemoveSelectedTag = function (a) {
...
var $author$project$SearchToolbar$viewTagChip = function (tag) {
	return A2(
		$elm$html$Html$div,
			...
			[
				...
				A2(
					...
					$elm$html$Html$Events$onClick(
						$author$project$SearchToolbar$RemoveSelectedTag(tag)),
...
var $author$project$SearchToolbar$viewSelectedTags = function (selectedTags) {
	return $elm$core$List$isEmpty(selectedTags) ? $elm$html$Html$text('') : A2(
		$elm$html$Html$div,
		$author$project$Theme$selectedTagsContainer,
		_Utils_ap(
			A2($elm$core$List$map, $author$project$SearchToolbar$viewTagChip, selectedTags),
			_List_fromArray(
				[$author$project$SearchToolbar$viewClearAllButton])));
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$SearchToolbar$viewSelectedTags(model.selectedTags),
							A2(
							$elm$html$Html$div,
							$author$project$Theme$select,
							_List_fromArray(
								[
									$elm$html$Html$text('Sort by'),
									A2(
									$elm$html$Html$div,
									$author$project$Theme$buttonGroup,
									_List_fromArray(
										[
											A2(
											$elm$html$Html$div,
											A2(
												$elm$core$List$cons,
												$elm$html$Html$Events$onClick(
													$author$project$SearchToolbar$SortOrderChanged('Created Date')),
											...
											A2(
												$elm$core$List$cons,
												$elm$html$Html$Events$onClick(
													$author$project$SearchToolbar$SortOrderChanged('Updated Date')),
...
var $author$project$TagPopup$view = function (model) {
	var _v0 = _Utils_Tuple2(model.position, model.tags);
	if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
		var _v1 = _v0.a.a;
		var top = _v1.a;
...
var $author$project$Main$AddNewLineAfter = function (a) {
	return {$: 'AddNewLineAfter', a: a};
};
...
var $author$project$Main$GetCurrentCursorCoordinates = {$: 'GetCurrentCursorCoordinates'};
var $author$project$Main$IndentItemAfter = function (a) {
	return {$: 'IndentItemAfter', a: a};
};
var $author$project$Main$InsertSelectedTagAfter = F2(
	function (a, b) {
		return {$: 'InsertSelectedTagAfter', a: a, b: b};
	});
var $author$project$Main$MoveItemDownAfter = function (a) {
	return {$: 'MoveItemDownAfter', a: a};
};
var $author$project$Main$MoveItemUpAfter = function (a) {
	return {$: 'MoveItemUpAfter', a: a};
};
var $author$project$Main$NavigateToNextAfter = function (a) {
	return {$: 'NavigateToNextAfter', a: a};
};
var $author$project$Main$NavigateToPreviousAfter = function (a) {
	return {$: 'NavigateToPreviousAfter', a: a};
};
var $author$project$Main$OutdentItemAfter = function (a) {
	return {$: 'OutdentItemAfter', a: a};
};
var $author$project$Clipboard$PasteItem = F2(
	function (a, b) {
...
var $author$project$Theme$editableDiv = _Utils_ap(
	$author$project$Theme$textarea,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'min-height', '1.8em')
		]));
...
var $author$project$KeyboardHandler$keyFromCode = function (code) {
	switch (code) {
		...
		case 27:
			return $author$project$KeyboardHandler$Escape;
		case 37:
			return $author$project$KeyboardHandler$Left;
		case 38:
			return $author$project$KeyboardHandler$Up;
		case 39:
	...
	function (config, item) {
		...
		return A2(
			...
			A5(
				$elm$json$Json$Decode$map4,
				F4(
					function (key, alt, shift, innerHtmlValue) {
						if (alt) {
							switch (key.$) {
								case 'Up':
									return _Utils_Tuple2(
										config.onMoveItemUpAfter(item),
										true);
								case 'Down':
									return _Utils_Tuple2(
										config.onMoveItemDownAfter(item),
										true);
								case 'X':
									return _Utils_Tuple2(
							...
							switch (key.$) {
								...
								case 'Enter':
									...
									if (!_v3.a) {
										...
										return _Utils_Tuple2(
											config.onAddNewLineAfter(item),
											true);
									}
								case 'Tab':
									return shift ? _Utils_Tuple2(
										config.onOutdentItemAfter(item),
										true) : _Utils_Tuple2(
										config.onIndentItemAfter(item),
										true);
								case 'Left':
									return _Utils_Tuple2(
...
var $author$project$SearchToolbar$AddTagToSelected = function (a) {
	return {$: 'AddTagToSelected', a: a};
};
var $author$project$SearchToolbar$addTagToSelected = function (tag) {
	return $author$project$SearchToolbar$AddTagToSelected(tag);
};
						...
						[
							...
							A2(
								...
								A2(
									...
									$elm$json$Json$Decode$succeed(
										_Utils_Tuple2(
											$author$project$Main$SearchToolbarMsg(
												$author$project$SearchToolbar$addTagToSelected(tag)),
											true))),
								tagStyle),
							_List_fromArray(
								[
									$elm$html$Html$text(m.match)
								]))
						]),
...
var $author$project$Main$viewItemContent = F2(
	function (model, item) {
		var onInputCustom = A2(
			$elm$html$Html$Events$on,
			'input',
			$elm$json$Json$Decode$succeed($author$project$Main$GetCurrentCursorCoordinates));
		...
		var keyboardConfig = {
			...
			onAddNewLineAfter: $author$project$Main$AddNewLineAfter,
			...
			onMoveItemDownAfter: $author$project$Main$MoveItemDownAfter,
			onMoveItemUpAfter: $author$project$Main$MoveItemUpAfter,
			onNavigateToNextAfter: $author$project$Main$NavigateToNextAfter,
			onNavigateToPreviousAfter: $author$project$Main$NavigateToPreviousAfter,
			onNoOp: $author$project$Main$NoOp,
			onOutdentItemAfter: $author$project$Main$OutdentItemAfter,
...
var $author$project$Main$viewListItem = F3(
	function (model, level, item) {
		var childrenBlock = $author$project$ListItem$isCollapsed(item) ? _List_Nil : A2(
			$elm$core$List$map,
			...
			A2(
				...
				_List_fromArray(
					[
						A2(
						$elm$html$Html$map,
						$author$project$Main$TagPopupMsg,
						$author$project$TagPopup$view(model.tagPopup))
					])),
			A2(
				$elm$core$List$cons,
				A2(
